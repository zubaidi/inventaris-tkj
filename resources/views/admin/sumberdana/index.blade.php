...
@section('content')
						...
						<div>
							...
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 small">
									...
									<li class="breadcrumb-item">
										<a href="{{ route('admin.sumber-dana.index') }}" class="text-decoration-none">Sumber Dana</a>
									</li>
							...
							<tbody>
								@forelse ($sumberDanas as $sumberDana)
									<tr>
										...
										<td data-order="{{ $sumberDana->inventaris_sum_jumlah_total ?? 0 }}">
											Rp {{ number_format((float) ($sumberDana->inventaris_sum_jumlah_total ?? 0), 0, ',', '.') }}
										</td>
										<td class="text-center">
											<div class="d-flex gap-1 justify-content-center">
												<button type="button" class="btn btn-sm btn-warning btn-edit-sumber-dana"
													title="Edit" data-bs-toggle="modal" data-bs-target="#modalEditSumberDana"
													data-id="{{ $sumberDana->id }}"
								...
								@empty
									<tr>
										<td colspan="5" class="text-center text-muted py-4">Belum ada data sumber dana.</td>
									</tr>
								@endforelse
							</tbody>
						</table>
	...
	<div class="modal fade" id="modalTambahSumberDana" tabindex="-1"
		aria-labelledby="modalTambahSumberDanaLabel" aria-hidden="true">
	...
	<div class="modal fade" id="modalEditSumberDana" tabindex="-1"
		aria-labelledby="modalEditSumberDanaLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form id="formEditSumberDana" action="" method="POST">
					...
					<div class="modal-body">
						<label for="edit_nama" class="form-label">Nama Sumber Dana <span class="text-danger">*</span></label>
